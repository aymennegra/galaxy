...
if (isset($_POST['modifier'])){
	$livraison=new livraison($_POST['idclient'],$_POST['nom'],$_POST['adresse'],$_POST['numtel'],$_POST['numcommande'],$_POST['liv']);
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item"  href="index-2.php"><span>Gestion Livreur </span></a></li>
								<li><a class="slide-item" href="index2.php"><span>Gestion Livraison</span></a></li>
